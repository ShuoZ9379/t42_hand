...
class zs_transition_experience_v2():
    path = '/home/szhang/Desktop/'
    dest_path = '/home/pracsys/catkin_ws/src/t42_control/gpup_gp_node/red_data/dataset_processed/' 

    def __init__(self, Object, version,color,Load=True, discrete = True, postfix='', with_fingers = False):
        ...
        if postfix == 'bu':
            ...
            self.file_name = self.path + self.color + '_data/zs_raw_' + self.Object + '_' + self.mode + '_v' + version + self.postfix + '.obj'
    ...
    def add(self, collect_idx, time, state, action, next_state, done):
        self.memory += [(collect_idx, time, state, action, next_state, done)]
