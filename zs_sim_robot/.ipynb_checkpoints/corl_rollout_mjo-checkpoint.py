...
for Sets in Sets_ls:
    for env_id in env_id_ls:
        ...
        ############################# Rollout ################################
        if rollout:
            files_pkl = glob.glob('./mjo_'+Sets+'_eval_results/'+env_id+'*.pkl')
            for set_mode in set_modes:
                files = glob.glob('./mjo_'+Sets+'_eval_results/'+env_id+'_'+set_mode+'*plan.txt')
                if set_modes_suf:
                    res_folder='./mjo_'+Sets+'_eval_results/'+env_id+'_'+set_mode+'_results/'
                else:
                    res_folder='./mjo_'+Sets+'_eval_results/'+env_id+'_results/'
