    ...
    for mode in ['_100ac2']:
        for ho_mode in ho_modes:
            for sdd in range(1,2):
                ...
                obs_set_path='/Users/zsbjltwjj/Downloads/t42_hand/beliefspaceplanning/rollout_node/set/'+set_idx+mode+ho_mode+'/'
                ...
                mplot_planned_traj(ho_mode,num_steps,set_mode,obs_set_path,initial_state,run_idx,goal_idx,plan_path,goal_loc,H1,H2,Obs,obs_dist,big_goal_radius)
