...
class PolicyWithValue(object):
    ...
    def __init__(self, env, env_type, observations, latent, estimate_q=False, vf_latent=None, sess=None, **tensors):
        """
        Parameters:
        ----------
        env             RL environment
    ...
    def load(self, load_path):
        ...
        functools.partial(load_variables, sess=get_session())(save_path)
...
def build_policy(env, policy_network, value_network=None,  normalize_observations=False, estimate_q=False, **policy_kwargs):
    ...
    def policy_fn(env_type, nbatch=None, sess=None, observ_placeholder=None):
