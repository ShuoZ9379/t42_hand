...
class Runner(AbstractEnvRunner):
    ...
    def run(self,do_eval=False,num_eval_eps=1,compare=False,compare_ah_idx=8,reacher_sd=1,acrobot_sd=1,min_trans=2000):
        ...
        if not do_eval:
            while len(mb_rewards)<min_trans:
                one_eps_done=False
                while not one_eps_done:
            ...
            if compare:
                ...
                if self.env.env_name=='ah':
                    ...
                    self.env.compare_reset(self.env.goals[compare_ah_idx].copy(),self.obs[0,:].copy())
